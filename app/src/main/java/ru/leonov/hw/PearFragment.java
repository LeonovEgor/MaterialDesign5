...
import ru.leonov.hw.Data.PearData;

public class PearFragment extends Fragment {

    public static PearFragment newInstance(Bundle bundle) {
        PearFragment currentFragment = new PearFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_pear_fruit, container, false);
    }
    ...
    private void initRecyclerView(View view) {
        ...
        Data data = new PearData(getContext());
