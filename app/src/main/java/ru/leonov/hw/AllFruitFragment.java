...
public class AllFruitFragment extends Fragment {

    public static AllFruitFragment newInstance(Bundle bundle) {
        AllFruitFragment currentFragment = new AllFruitFragment();
