...
import ru.leonov.hw.Data.PotatoData;
import ru.leonov.hw.Data.VegetablesData;

public class PotatoFragment extends Fragment {

    public static PotatoFragment newInstance(Bundle bundle) {
        PotatoFragment currentFragment = new PotatoFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_potato_vegetables, container, false);
    }
    ...
    private void initRecyclerView(View view) {
        ...
        Data data = new PotatoData(getContext());
