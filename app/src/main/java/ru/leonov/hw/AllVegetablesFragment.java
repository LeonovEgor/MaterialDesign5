...
public class AllVegetablesFragment extends Fragment {

    public static AllVegetablesFragment newInstance(Bundle bundle) {
        AllVegetablesFragment currentFragment = new AllVegetablesFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_all_vegetables, container, false);
    }
